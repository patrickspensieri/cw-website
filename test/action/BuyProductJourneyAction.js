jQuery.sap.declare("ui.test.action.BuyProductJourneyAction");
...
ui.test.action.BuyProductJourneyAction = sap.ui.test.Opa5.extend("ui.test.action.BuyProductJourneyAction", {
